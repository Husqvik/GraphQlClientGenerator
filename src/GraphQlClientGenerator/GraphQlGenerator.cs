...
namespace GraphQlClientGenerator
{
    public static class GraphQlGenerator
    {
        ...
        private const string DisableNewtonsoftJsonDefinition = "DISABLE_GRAPHQL_GENERATOR_NEWTONSOFT_JSON";

        internal static readonly string RequiredNamespaces =
            $@"using System;
...
#if !{DisableNewtonsoftJsonDefinition}
using Newtonsoft.Json;
...
";
            ...
            StringBuilder builder)
        {
            ...
            {
                builder.AppendLine($"#if !{DisableNewtonsoftJsonDefinition}");
